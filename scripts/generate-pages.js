...
<body>
	...
	<div class="site-shell">
		...
		<main>
			<section class="hero" aria-labelledby="pageTitle"><div class="hero-copy"><h1 id="pageTitle">${s.tagline} ${s.boBeta}</h1><p class="eyebrow">${s.eyebrow}</p></div><div id="selectedDay" class="today-card" aria-live="polite"></div><article id="nextSpecialDay" class="next-card" aria-live="polite"><p class="section-kicker">${s.next}</p><div class="skeleton-line"></div></article><div class="hero-context"><button id="basisButton" class="basis-button" type="button"><span>${s.basis}</span><strong id="basisLabel">—</strong></button><div id="dateDiscrepancy" class="date-notice" hidden></div></div></section>
